...
import eu.android.a7minutesworkout.databinding.ActivityBmiBinding
...
class BMIActivity : AppCompatActivity() {
    ...
    private fun makeVisibleMetricUnitsView() {
        ...
        binding.tilUsMetricUnitWeight.visibility = GONE
        binding.tilMetricUsUnitHeightFeet.visibility = GONE
        binding.tilMetricUsUnitHeightInch.visibility = GONE

        binding.etMetricUnitHeight.text!!.clear()
        binding.etMetricUnitWeight.text!!.clear()

        binding.llDiplayBMIResult.visibility = INVISIBLE
    }

    private fun makeVisibleUsUnitsView() {
        currentVisibleView = US_UNITS_VIEW
        binding.tilMetricUnitHeight.visibility = INVISIBLE
        binding.tilMetricUnitWeight.visibility = INVISIBLE
